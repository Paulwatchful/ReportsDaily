...
urlpatterns = [
    ...
    path('email_template/edit/<int:pk>/', views.email_template_edit, name='email_template_edit'),
    path('email_template/add/', views.email_template_add, name='email_template_add'),
    path('recipient/edit/<int:pk>/', views.recipient_edit, name='recipient_edit'),
